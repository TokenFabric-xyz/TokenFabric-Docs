...
- **Heko.Club**: [COMING SOON] A social graph / network with unique monetization features and digital asset integration
- **Forgotten Yellow Duck**: [COMING SOON] Onchain game with unique gameplay and monetization features
...
- **Zenvest**: A platform for tokenized equities and RWA
- **Contribute To Earn (C2E)**: [COMING SOON] A plateform allowing anyone to contribute to projects and earn rewards
