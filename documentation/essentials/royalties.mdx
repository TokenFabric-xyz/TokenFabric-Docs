...
In this setup, every purchase of EXT incurs a 1% fee, and every sale a 1.5% fee. Of the collected royalties, 70% goes to the DAO treasury for ongoing operations, while 30% is used in a smart contract to automatically buy back and burn EXT tokens.
...
<Card title="Need Help?" icon="question" href="mailto:support@tokenfabric.xyz">
